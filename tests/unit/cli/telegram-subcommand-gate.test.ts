...
beforeEach(() => {
  ...
  for (const spy of [sendDocumentSpy, editMessageTextSpy, answerCallbackQuerySpy, setMessageReactionSpy]) {
    spy.mockClear();
  }
...
async function expectGateBlock(args: string[]): Promise<void> {
